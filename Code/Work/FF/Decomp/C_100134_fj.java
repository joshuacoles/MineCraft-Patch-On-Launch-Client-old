...
final class C_100134_fj extends Formatter {

   private SimpleDateFormat field_106499_a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");


   public String format(LogRecord var1) {
      StringBuilder var2 = new StringBuilder();
      var2.append(this.field_106499_a.format(Long.valueOf(var1.getMillis())));
