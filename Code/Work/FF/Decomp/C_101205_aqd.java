...
public class C_101205_aqd extends Panel {

   public C_101205_aqd(C_100007_a var1) {
      this.setBackground(new Color(3028036));
      this.setLayout(new BorderLayout());
      StringWriter var2 = new StringWriter();
      var1.func_105187_b().printStackTrace(new PrintWriter(var2));
      ...
      if(var3.contains("Pixel format not accelerated")) {
         ...
         var6 = var6 + "      ----------------------      \n";
         var6 = var6 + "\n";
         var6 = var6 + "Minecraft has stopped running because it encountered a problem; " + var1.func_105183_a() + "\n";
         File var7 = var1.func_105179_f();
         if(var7 == null) {
            var1.func_105190_a(new File(new File(Minecraft.func_105056_b(), "crash-reports"), "crash-" + (new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date()) + "-client.txt"));
            var7 = var1.func_105179_f();
         }
      ...
      this.add(new C_101206_aqf(), "North");
      this.add(new C_101204_aqe(80), "East");
      this.add(new C_101204_aqe(80), "West");
      this.add(new C_101204_aqe(100), "South");
