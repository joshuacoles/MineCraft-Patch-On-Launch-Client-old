...
public class C_100998_ayc extends C_100988_axw {

   float field_104660_a;


   public C_100998_ayc(C_100873_xe var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      this(var1, var2, var4, var6, var8, var10, var12, 1.0F);
   }

   public C_100998_ayc(C_100873_xe var1, double var2, double var4, double var6, double var8, double var10, double var12, float var14) {
      ...
      this.field_104660_a = this.field_104609_f;
   ...
   public void func_104606_a(C_100872_azb var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      this.field_104609_f = this.field_104660_a * var8;
   ...
   public void func_103165_j_() {
      ...
      this.field_103240_x *= 0.9900000095367432D;
