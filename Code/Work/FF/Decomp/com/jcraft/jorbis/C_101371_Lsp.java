...
import com.jcraft.jorbis.C_101388_Lookup;

class C_101371_Lsp {

   static final float field_101549_M_PI = 3.1415927F;


   static void func_101548_lsp_to_curve(float[] var0, int[] var1, int var2, int var3, float[] var4, int var5, float var6, float var7) {
      float var9 = 3.1415927F / (float)var3;

      int var8;
      for(var8 = 0; var8 < var5; ++var8) {
         var4[var8] = C_101388_Lookup.func_101934_coslook(var4[var8]);
      }
      ...
      while(var8 < var2) {
         ...
         float var14 = C_101388_Lookup.func_101934_coslook(var9 * (float)var11);
         ...
         var13 = C_101388_Lookup.func_101937_fromdBlook(var6 * C_101388_Lookup.func_101936_invsqlook(var13) * C_101388_Lookup.func_101935_invsq2explook(var17 + var5) - var7);
