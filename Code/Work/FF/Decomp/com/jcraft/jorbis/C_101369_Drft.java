...
class C_101369_Drft {
   ...
   int field_101532_n;
   float[] field_101534_trigcache;
   int[] field_101531_splitcache;
   static int[] field_101529_ntryh = new int[]{4, 2, 3, 5};
   static float field_101528_tpi = 6.2831855F;
   static float field_101535_hsqt2 = 0.70710677F;
   static float field_101530_taui = 0.8660254F;
   static float field_101533_taur = -0.5F;
   static float field_101527_sqrt2 = 1.4142135F;


   void func_101513_backward(float[] var1) {
      if(this.field_101532_n != 1) {
         func_101521_drftb1(this.field_101532_n, var1, this.field_101534_trigcache, this.field_101534_trigcache, this.field_101532_n, this.field_101531_splitcache);
      }
   }

   void func_101523_init(int var1) {
      this.field_101532_n = var1;
      this.field_101534_trigcache = new float[3 * var1];
      this.field_101531_splitcache = new int[32];
      func_101515_fdrffti(var1, this.field_101534_trigcache, this.field_101531_splitcache);
   }

   void func_101514_clear() {
      if(this.field_101534_trigcache != null) {
         this.field_101534_trigcache = null;
      }

      if(this.field_101531_splitcache != null) {
         this.field_101531_splitcache = null;
      }

   }

   static void func_101524_drfti1(int var0, float[] var1, int var2, int[] var3) {
      int var8 = 0;
      int var10 = -1;
      int var24 = var0;
      int var25 = 0;
         ...
         while(true) {
            ...
            case 107:
               if(var24 == 1) {
                  var3[0] = var0;
                  var3[1] = var25;
                  float var5 = field_101528_tpi / (float)var0;
                  int var18 = 0;
                  int var23 = var25 - 1;
                  int var12 = 1;
                  if(var23 == 0) {
   ...
   static void func_101515_fdrffti(int var0, float[] var1, int[] var2) {
      if(var0 != 1) {
         func_101524_drfti1(var0, var1, var0, var2);
      }
   }

   static void func_101522_dradf2(int var0, int var1, float[] var2, float[] var3, float[] var4, int var5) {
      int var11 = 0;
      int var12;
   ...
   static void func_101519_dradf4(int var0, int var1, float[] var2, float[] var3, float[] var4, int var5, float[] var6, int var7, float[] var8, int var9) {
      int var12 = var1 * var0;
      int var13 = var12;
      int var16 = var12 << 1;
      ...
      if(var0 >= 2) {
         ...
         for(var11 = 0; var11 < var1; ++var11) {
            var25 = -field_101535_hsqt2 * (var2[var13] + var2[var14]);
            var29 = field_101535_hsqt2 * (var2[var13] - var2[var14]);
   ...
   static void func_101517_dradfg(int var0, int var1, int var2, int var3, float[] var4, float[] var5, float[] var6, float[] var7, float[] var8, float[] var9, int var10) {
      int var22 = 0;
      float var38 = 0.0F;
      float var40 = 0.0F;
      float var39 = field_101528_tpi / (float)var1;
   ...
   static void func_101520_drftf1(int var0, float[] var1, float[] var2, float[] var3, int[] var4) {
      int var11 = var4[1];
      int var9 = 1;
      int var8 = var0;
      int var13 = var0;
         ...
         while(true) {
            ...
            case 100:
               if(var12 != 4) {
                  ...
                  if(var9 != 0) {
                     func_101519_dradf4(var14, var7, var2, var1, var3, var13 - 1, var3, var16 - 1, var3, var17 - 1);
                  } else {
                     func_101519_dradf4(var14, var7, var1, var2, var3, var13 - 1, var3, var16 - 1, var3, var17 - 1);
                  }
            ...
            case 102:
               if(var12 != 2) {
                  ...
                  func_101522_dradf2(var14, var7, var1, var2, var3, var13 - 1);
                  var18 = 110;
               }
               break;
            case 103:
               func_101522_dradf2(var14, var7, var2, var1, var3, var13 - 1);
            case 104:
               if(var14 == 1) {
                  var9 = 1 - var9;
               }
               ...
               if(var9 != 0) {
                  ...
                  func_101517_dradfg(var14, var12, var7, var15, var1, var1, var1, var2, var2, var3, var13 - 1);
                  var9 = 1;
                  var18 = 110;
               }
               break;
            case 109:
               func_101517_dradfg(var14, var12, var7, var15, var2, var2, var2, var1, var1, var3, var13 - 1);
               var9 = 0;
            case 110:
               var8 = var7;
               ++var6;
   ...
   static void func_101516_dradb2(int var0, int var1, float[] var2, float[] var3, float[] var4, int var5) {
      int var8 = var1 * var0;
      int var9 = 0;
      int var10 = 0;
      int var11 = (var0 << 1) - 1;
   ...
   static void func_101518_dradb3(int var0, int var1, float[] var2, float[] var3, float[] var4, int var5, float[] var6, int var7) {
      int var10 = var1 * var0;
      int var11 = 0;
      int var12 = var10 << 1;
      int var13 = var0 << 1;
      ...
      for(var9 = 0; var9 < var1; ++var9) {
         ...
         var25 = var2[var15] + field_101533_taur * var30;
         var3[var11] = var2[var15] + var30;
         var22 = field_101530_taui * (var2[var13] + var2[var13]);
      ...
      if(var0 != 1) {
         ...
         for(var9 = 0; var9 < var1; ++var9) {
            ...
            for(int var8 = 2; var8 < var0; var8 += 2) {
               ...
               var25 = var2[var17 - 1] + field_101533_taur * var30;
               var3[var18 - 1] = var2[var17 - 1] + var30;
               float var29 = var2[var15] - var2[var16];
               float var21 = var2[var17] + field_101533_taur * var29;
               var3[var18] = var2[var17] + var29;
               float var26 = field_101530_taui * (var2[var15 - 1] - var2[var16 - 1]);
               var22 = field_101530_taui * (var2[var15] + var2[var16]);
   ...
   static void func_101525_dradb4(int var0, int var1, float[] var2, float[] var3, float[] var4, int var5, float[] var6, int var7, float[] var8, int var9) {
      int var12 = var1 * var0;
      int var13 = 0;
      int var14 = var0 << 2;
      int var15 = 0;
      ...
      if(var0 >= 2) {
         ...
         for(var11 = 0; var11 < var1; ++var11) {
            ...
            var3[var17 = var15 + var12] = field_101527_sqrt2 * (var31 - var27);
            var3[var17 += var12] = var28 + var28;
            var3[var17 + var12] = -field_101527_sqrt2 * (var31 + var27);
            var15 += var0;
            var13 += var14;
            var16 += var14;
         }
   ...
   static void func_101526_dradbg(int var0, int var1, int var2, int var3, float[] var4, float[] var5, float[] var6, float[] var7, float[] var8, float[] var9, int var10) {
      int var12 = 0;
      int var19 = 0;
      int var29 = 0;
      int var38 = 0;
      ...
      while(true) {
         ...
         case 100:
            var29 = var1 * var0;
            var19 = var2 * var0;
            float var40 = field_101528_tpi / (float)var1;
   ...
   static void func_101521_drftb1(int var0, float[] var1, float[] var2, float[] var3, int var4, int[] var5) {
      int var9 = 0;
      int var12 = 0;
      int var16 = 0;
      int var17 = 0;
         ...
         while(true) {
            ...
            case 100:
               ...
               if(var12 != 4) {
                  ...
                  if(var10 != 0) {
                     func_101525_dradb4(var16, var8, var2, var1, var3, var4 + var13 - 1, var3, var4 + var14 - 1, var3, var4 + var15 - 1);
                  } else {
                     func_101525_dradb4(var16, var8, var1, var2, var3, var4 + var13 - 1, var3, var4 + var14 - 1, var3, var4 + var15 - 1);
                  }
            ...
            case 103:
               if(var12 != 2) {
                  ...
                  if(var10 != 0) {
                     func_101516_dradb2(var16, var8, var2, var1, var3, var4 + var13 - 1);
                  } else {
                     func_101516_dradb2(var16, var8, var1, var2, var3, var4 + var13 - 1);
                  }
            ...
            case 106:
               if(var12 != 3) {
                  ...
                  var14 = var13 + var16;
                  if(var10 != 0) {
                     func_101518_dradb3(var16, var8, var2, var1, var3, var4 + var13 - 1, var3, var4 + var14 - 1);
                  } else {
                     func_101518_dradb3(var16, var8, var1, var2, var3, var4 + var13 - 1, var3, var4 + var14 - 1);
                  }
            ...
            case 109:
               if(var10 != 0) {
                  func_101526_dradbg(var16, var12, var8, var17, var2, var2, var2, var1, var1, var3, var4 + var13 - 1);
               } else {
                  func_101526_dradbg(var16, var12, var8, var17, var1, var1, var1, var2, var2, var3, var4 + var13 - 1);
               }
